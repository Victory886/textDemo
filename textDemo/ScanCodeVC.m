...
- (void)viewDidLoad {
    ...
    CGRect rect = CGRectMake((kScreenWidth - 250) / 2, (kScreenHeight - 250 - 50)/2, 250, 250);
    ...
    [rectPath appendPath:[[UIBezierPath bezierPathWithRoundedRect:CGRectMake((kScreenWidth - 250) / 2, (kScreenHeight - 250 - 50)/2, 250, 250) cornerRadius:1] bezierPathByReversingPath]];
...
//    _sweepLineView.image = [UIImage imageNamed:@"scan_code_line"];
    self.sweepLineView.backgroundColor = [UIColor redColor];
